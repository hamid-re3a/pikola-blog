...
Route::get('storage/canvas/images/{file}',[\App\Http\Controllers\CanvasUiController::class,'serve']);
Route::get('/',[\App\Http\Controllers\CanvasUiController::class,'showPosts']);
Route::get('single-post/{slug}', [\App\Http\Controllers\CanvasUiController::class, 'viewPost']);
